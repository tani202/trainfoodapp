...
public class Delivery_sendotp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        entercode=(EditText) findViewById(R.id.ccode);
        txt=(TextView) findViewById(R.id.txt);
        Resend=(Button) findViewById(R.id.rsendotp);
    ...
    private void signInWithPhone(PhoneAuthCredential credential) {
        FAuth.signInWithCredential(credential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                {
                    startActivity(new Intent(Delivery_sendotp.this,ChefFoodPanel_BottomNavigation.class));
                    finish();
                }
                else
                {
                    ResuableCodeForAll.ShowAlert(Delivery_sendotp.this,"ERROR",task.getException().getMessage());
                }
